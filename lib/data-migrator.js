...
DataMigrator.prototype.addPath = function addPath(params) {
  ...
  if ( _.has(params, 'fromCondition') ) {
    ...
    if ( ! _.has(this._conditions, params.fromCondition) && ! _.has(internalCondition, params.fromCondition) ) 
  ...
  if ( _.has(params, 'toCondition') ) {
    ...
    if ( ! _.has(this._conditions, params.toCondition) && ! _.has(internalCondition, params.toCondition) ) 
